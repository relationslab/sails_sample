...
React.render(React.createElement(TestList, null), document.getElementById('testList'));


},{"./testList.jsx":158,"react":156}],158:[function(require,module,exports){
var React = require('react');

var TestList = React.createClass({displayName: "TestList",
  getInitialState : function() {
    return {
      users: [
  ...
  render: function() {
    var list = this.state.users.map((user) => {
      return React.createElement("li", {key: user.id}, React.createElement(TestItem, {user: user}));
    });
...
var TestItem = React.createClass({displayName: "TestItem",
  propTypes: {
