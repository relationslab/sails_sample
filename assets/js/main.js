...
React.render(React.createElement(ArticleList, {fetch: "/api/article/find"})
...
/*
  ...
  render: function() {
    var list = this.state.articles.map(function(article) {
      return React.createElement("li", {key: article.id, className: "articleList_item"}, React.createElement(ArticleListItem, {article: article}));
    });

    return React.createElement("ul", {className: "articleList articleList_list"}, list);
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("h1", {className: "articleList_title"}, 
        ...
        React.createElement("div", {className: "articleList_body"}, 
          ...
          React.createElement("a", {className: "articleList_body_link", href: "/article/"+this.props.article.id}, "続きを読む→")
        )
      )
    );
  }
